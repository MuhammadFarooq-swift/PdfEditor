          ...
          <div className="relative">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <div className="mt-10 flex flex-col items-center justify-center gap-5 sm:flex-row">
                ...
                >
                  <span className="absolute left-0 top-0 h-full w-full bg-gradient-to-r from-purple-600 via-red-500 to-orange-400 opacity-0 transition-opacity group-hover:opacity-100"></span>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group relative inline-flex items-center justify-center overflow-hidden rounded-full bg-gradient-to-r from-purple-600 via-red-500 to-orange-400 px-8 py-4 text-base font-medium text-white shadow-xl transition-all hover:scale-105 hover:shadow-2xl"
                >
