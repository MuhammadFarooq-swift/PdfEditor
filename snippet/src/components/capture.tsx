        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-end space-x-3 border-t border-gray-200 pt-4">
            ...
            <Button
              ...
              className="rounded-md border border-transparent bg-red-600 px-4 py-2 text-sm text-white hover:!bg-red-700 disabled:cursor-not-allowed disabled:opacity-50"
            >
              Download
            </Button>
          </div>
